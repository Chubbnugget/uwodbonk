...
---
# Discovery: greek tablet

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Historical Relics |
| **Discovery Name** | greek tablet |
| **Rank** | ★☆☆☆☆(1) (Number of Stars on Discovery Name card) |
| **explanation** | A stone tablet inscribed with Greek letters. It is probably engraved with an inscription to preserve it for a long time. |
| **Era** |  |
