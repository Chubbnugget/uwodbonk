...
category: Plant
---
# Discovery: Mareshervia

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Plant |
| **Discovery Name** | Mareshervia |
| **Rank** | ★☆☆☆☆(1) (Number of Stars on Discovery Name card) |
| **explanation** | It lives only in the arid regions of southwestern South America. The petals are shaped like stars, and the flowers bloom in white or purple. |
| **Era** |  |
