...
category: Treasure
---
# Discovery: Kazan platter

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Treasure |
| **Discovery Name** | Kazan platter |
| **Rank** | ★★★☆☆(3) (Number of Stars on Discovery Name card) |
| **explanation** | golden platter. "Kazan" means "large plate". Legend has it that once a Tatar princess dropped a golden platter into the river, which led to the place being called Kazan. |
| **Era** |  |
...
| **最終更新** | 2022-06-05 09:42:13 Mifuyu |
