...
category: Treasure
---
# Discovery: silver kabukirishi decoration

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Treasure |
| **Discovery Name** | silver kabukirishi decoration |
| **Rank** | ★★★☆☆(3) (Number of Stars on Discovery Name card) |
| **explanation** | A grave goods made of silver alloy in the shape of a semicircle. When you shake it, the ball on the edge of the circle makes a noise. Was it used for festivals that involved sound? |
| **Era** |  |
...
| **Remarks** | ritual symbol

 Discovery Experience 530 Discovery Name Card Experience 265 |
| **最終更新** | 2016-05-03 20:44:07 Gainor |
