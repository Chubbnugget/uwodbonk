...
category: Treasure
---
# Discovery: Stars flowers

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Treasure |
| **Discovery Name** | Stars flowers |
| **Rank** | ★★★★☆(4) (Number of Stars on Discovery Name card) |
| **explanation** | A pink gemstone produced on the west coast of South America. Also called Inca Rose. The gentle colors like flowers and the brightness of the stars will soothe the viewer's fatigue and evoke a simple and warm feeling. |
| **Era** |  |
...
| **Remarks** | healing jewel |
| **最終更新** | 2020-11-23 16:29:15 Passing navigator @guest |
