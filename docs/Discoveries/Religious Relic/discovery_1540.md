...
---
# Discovery: mosaic disc

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Religious Relic |
| **Discovery Name** | mosaic disc |
| **Rank** | ★★☆☆☆(2) (Number of Stars on Discovery Name card) |
| **explanation** | A mosaic disc made of turquoise. Made using extremely advanced technology. The Aztecs considered the color sacred and used turquoise in their festivals. |
| **Era** |  |
