...
---
# Discovery: golden raft

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Religious Relic |
| **Discovery Name** | golden raft |
| **Rank** | ★★★★★(5) (Number of Stars on Discovery Name card) |
| **explanation** | A golden raft used in ceremonies by the Chibcha people. The chief performs a ritual in which he coats his entire body with gold powder and jumps into the lake from a golden raft on a moonlit night. |
| **Era** |  |
...
| **Remarks** | golden raft |
| **最終更新** | 2020-11-18 08:13:02 Passing navigator @guest |
