...
category: Insect
---
# Discovery: giant praying mantis

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Insect |
| **Discovery Name** | giant praying mantis |
| **Rank** | ★★★☆☆(3) (Number of Stars on Discovery Name card) |
| **explanation** | A large praying mantis that lives in East Asia. They have a violent temper and are carnivorous, sometimes even eating cannibals. Females lay foamy egg sacs on plant branches. Approximately 200 larvae are born, but only a few of them become adults. |
| **Era** |  |
...
| **Remarks** |  |
| **最終更新** | 2020-04-09 12:39:39 Passing navigator @guest |
