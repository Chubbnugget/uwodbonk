...
---
# Discovery: lesser siren

## Discovery Details
| Attribute | Details |
| :--- | :--- |
| **Discovery Type** | Small Creature |
| **Discovery Name** | lesser siren |
| **Rank** | ★☆☆☆☆(1) (Number of Stars on Discovery Name card) |
| **explanation** | An amphibian with an eel-like body and two limbs. The limbs have four fingers and are well-structured. |
| **Era** |  |
