...
# Details of the quest [Light Dish of the Colossus]
...
| Attribute | Details |  
| :--- | :--- |  
| **Quest Name** | colossus lamp plate |  
...
| **Chain Quests** |  |  
| **Notes** | 1. North corner of Florence (in front of the gate) Legacy Port Town Rhodes Obtained Sophia 300 Pursuit production release: Classification "Bonfire" Obtained the title of Bonfire Researcher |  