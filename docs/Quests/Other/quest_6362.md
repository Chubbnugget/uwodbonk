...
category: Other
---
# Details of the quest [Fish map with line patterns]

### Details of the quest [Fish map with line patterns]

| Attribute | Details |
| :--- | :--- |
| **Quest Name** | Fish map with line patterns |

### Quest Contents
Basin south of Cayenne.
...
| **Items Obtained** |  |
| **Chain Quests** |  |
| **Notes** | A little further from the mouth of the Amazon River (14040,4868) |