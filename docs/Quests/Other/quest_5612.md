...
### Quest Contents
Outside the gates of Tacoma. Rocky region in the back. Exit the gate and go east.
...
| **Items Obtained** |  |  
| **Chain Quests** |  |  
| **Notes** | In the outskirts of Tacoma (Rocky Mountains) Near Table Rock on the east side of the map. (*There seems to be some premise. It didn't work after taking 10 headache medicines.) When I discovered ``Sweat Lodge,'' I was able to get the headache right away without using any headache medicine. |  