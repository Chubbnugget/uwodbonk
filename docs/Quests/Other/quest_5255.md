...
| **Discovery** | [Historical Relic](Categories/category_7.md) / [Canoe of the Orosiva Brothers](Quests/Adventure/quest_2667.md) A canoe that is said to have been used by the Orosiva Brothers, who created this ruins, to cross to the island. Judging from the extent of the damage, it appears that it continued to be used to travel between the islands. Rank: 2, Points: 6, Difficulty: 8 |
| **Reward/Advance** |  |
| **Exp/Fame** |  |
| **Items Obtained** |  |
| **Chain Quests** |  |
