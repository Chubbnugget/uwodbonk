...
### Quest [Ancient Ruins] Details

| Attribute | Details |
| :--- | :--- |
| **Quest Name** | Ancient Ruins |

### Quest Contents
There seems to be a rumor going around that the ruins of an old country called Gushu have been discovered around Chongqing. Please check on-site to check whether it is true or false.
...
| **Chain Quests** |  |
| **Notes** | 1. Chongqing Tavern Sailor 2. Chongqing Tavern Owner 3. Southwest Chongqing West Big Rock, visible 19m west, 4m north |