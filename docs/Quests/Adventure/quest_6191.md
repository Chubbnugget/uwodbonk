...
category: Adventure
---
# Quest [Immortal Snake]

### Quest [Immortal Snake] Details

| Attribute | Details |
| :--- | :--- |
| **Quest Name** | Immortal Snake |

### Quest Contents
You've been to a sacred place on the southern continent several times. I'd like you to investigate the legends about snakes that are passed down there. I guess information can be gathered in Kakadu.
...
| **Chain Quests** |  |
| **Notes** | 1　Kakadu Trader 2　Kakadu Resident x2 3　Kakadu Trader 4　Australia's northwest coast hinterland, around Uluru, stacked rocks in the southwest of the map 6m south, 47m east Visibility: 140 sheets with language available. Even without language, I was able to get 0 pages right away. |