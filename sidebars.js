      ...
      items: [
        {
          ...
          link: { type: 'doc', id: 'Categories/39' }, // Clicking the label goes here
          collapsed: true, // This keeps the sub-items hidden initially
          items: [{type: 'autogenerated', dirName: 'Skills/Skill-Adventure'}],
        },
        {
          type: 'category',
          label: 'Trade Skills',
          ...
          collapsed: true,
          items: [{type: 'autogenerated', dirName: 'Skills/Skill-Trade'}],
        },
        {
          type: 'category',
          label: 'Battle Skills',
          ...
          collapsed: true,
          items: [{type: 'autogenerated', dirName: 'Skills/Skill-Battle'}],
        },
      ],
    },
  ],
